...
def parse_args(script):
  ...
  parser.add_argument('--save_dir'    , default='output2', type=str, help='')
  ...
  parser.add_argument('--outfile', action='store_true', help='training progress outfile')
  ...
  if 'train' in script:
    ...
    if 'contrastive' in script:
      ...
      if 'l1' in script:
        ...
        parser.add_argument('--tau', default=0.5, type=float, help='temperature')
        parser.add_argument('--cosine_fac', default=10.0, type=float, help='temperature for cosine classifier')
        ...
        parser.add_argument('--n_unlab_neg', default=20, type=int, help='negatives bsz from unlabelled data')
        ...
        parser.add_argument('--num_tasks', default=50, type=int, help='num_tasks')
        ...
        parser.add_argument('--unlab_split', default='./filelists/miniImagenet/base.json', type=str, help='cssf finetuning type')

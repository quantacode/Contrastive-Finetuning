...
# --ft_mode 'ewn_lpan' \
# --ufsl_dataset --hyperparam_select \
# --is_tgt_aug --n_shot 5 --test_n_way 2 --n_query 5  \
# --train_aug --method 'weight_imprint' --model 'Conv4_medium' \
# --stop_epoch 400 --num_tasks 166  --lr 0.0005 \
# --targetset celeba --tau 0.1 --n_unlab_neg 64 \
# --name 'cssf_WIEval_5shot/ewn_lpan/hyperparam_select/arch-Conv4_medium_cosineLC_Pretrain-Src/celeba-tgt_mIN-src/augSrc-False_augTgt-True/neg-L16U64_ftEP-400_lr-0.0005_tau-0.1' \
# --load-modelpath 'output2/simclr/arch-Conv4_medium_Proj128_Pretrain-random/celeba_TARGETSET/nway-512_naug-2_tau-0.1/chkpt/model_500.tar' \
# --run_id $pid &
# done
...
--is_tgt_aug --n_shot 5 --test_n_way 2 --n_query 5  \
--train_aug --method 'weight_imprint' --model 'Conv4_medium' \
--stop_epoch 600 --num_tasks 166 --lr 0.0005 \
--targetset celeba --cosine_fac 10.0 \
--name 'cssf_WIEval_5shot/ce/testing/arch-Conv4_medium_cosineLC_Pretrain-Src/celeba-tgt_mIN-src/augSrc-False_augTgt-True/bsz-25_ftEP-600_lr-0.0005' \
--load-modelpath 'output2/simclr/arch-Conv4_medium_Proj128_Pretrain-random/celeba_TARGETSET/nway-512_naug-2_tau-0.1_Aug2/chkpt/model_300.tar' \
--run_id $pid &
done
...
# --targetset CUB --tau 0.1 --n_query 1 --augstrength 'relaxed' \
